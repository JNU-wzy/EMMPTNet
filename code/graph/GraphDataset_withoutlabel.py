...
# from utils.config import *
# params = config()
# dataset = TrainDataset(raw_dir=r"D:\Project\Pytorch_project\binding affinity\R-SIM\train\Excel\structure\Aptamers.xlsx", save_dir=f'dglgraph/Aptamers_k{params.k}_d{params.d}_smiles')
params = config()
dataset = TrainDataset(raw_dir=r"D:\Project\Pytorch_project\binding affinity\MST\seq.xlsx", save_dir=rf'D:\Project\Pytorch_project\binding affinity\MST\PredQ1_k{params.k}_d{params.d}_smiles')